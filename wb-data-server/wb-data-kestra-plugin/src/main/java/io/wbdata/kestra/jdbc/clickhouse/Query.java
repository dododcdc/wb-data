package io.wbdata.kestra.jdbc.clickhouse;
...
@Getter
@NoArgsConstructor
@Schema(title = "Execute a SQL-aware parameterized query against ClickHouse")
@Plugin
public class Query extends io.kestra.plugin.jdbc.clickhouse.Query {
