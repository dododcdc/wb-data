package io.wbdata.kestra.jdbc.postgresql;
...
@Getter
@NoArgsConstructor
@Schema(title = "Execute a SQL-aware parameterized query against PostgreSQL")
@Plugin
public class Query extends io.kestra.plugin.jdbc.postgresql.Query {
