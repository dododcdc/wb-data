            ...
            {!config && !canEdit ? (
                ...
                <div className="git-settings-ro-table">
                    <div className="git-settings-ro-row">
                        ...
                        <span className="git-settings-ro-value">{PROVIDERS.find(p => p.value === provider)?.label ?? provider}</span>
                    </div>
                    ...
                    <div className="git-settings-ro-row">
                        ...
                        <span className="git-settings-ro-value">{config.tokenMasked ? config.tokenMasked : '****'}</span>
                    </div>
                </div>
            ) : (
                <>
